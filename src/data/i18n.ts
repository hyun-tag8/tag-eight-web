...
export const t: Record<Lang, Dict> = {
  ja: {
    ...
    privacy: {
      ...
      revised: '制定日：2026年8月17日　改定日：2026年8月27日',
      metaTitle: 'プライバシーポリシー｜TAG EIGHT',
      metaDesc: 'TAG EIGHT合同会社の個人情報の取り扱いについて。',
      sections: [
        { h: '取得する情報', body: ['当社は、お問い合わせフォームおよび資料ダウンロードフォームを通じて以下の情報を取得します。'],
          list: ['会社名・団体名', 'お名前', 'メールアドレス', 'ご相談内容・メッセージ本文', '同意の記録（同意日時および同意いただいた項目）'] },
        { h: '利用目的', body: ['取得した個人情報は、次の目的の範囲内で利用します。'],
          list: ['お問い合わせへの回答およびご連絡', 'サービスのご提案・お打ち合わせの調整', '契約の締結および履行', '資料のご提供およびそれに関するご連絡', 'メールマガジンの配信（別途ご同意いただいた場合に限ります）'] },
        { h: 'メールマガジンの配信', body: [
            'メールマガジンは、配信について個別にご同意いただいた方にのみお送りします。資料のダウンロードに際して配信への同意を必須とすることはありません。',
            '配信するメールには、送信者名、当社の住所、および配信停止の方法を記載します。配信停止のお手続きは、メール内のリンクからいつでも行っていただけます。',
            'お問い合わせフォームのみをご利用いただいた方に対して、メールマガジンをお送りすることはありません。'] },
        { h: '第三者提供', body: ['当社は、法令に基づく場合を除き、ご本人の同意なく個人情報を第三者に提供することはありません。'] },
        { h: '外国にある第三者への提供', body: [
            '各フォームから送信された情報は、メールの送受信および配信のため、国外に所在する事業者のサーバーを経由します。',
            '当社は、送信および配信の目的の範囲内でのみ当該事業者を利用し、それ以外の目的で情報を提供することはありません。',
            '各事業者のプライバシーポリシーは、それぞれの公式サイトでご確認いただけます。'],
          list: ['メールの送受信：Google Workspace（米国）', 'ホスティング：Cloudflare（米国）', 'メールマガジンの配信：メール配信サービス事業者（EU域内）'] },
        { h: '安全管理', body: ['当社は、個人情報の漏えい、滅失または毀損の防止その他の安全管理のために、必要かつ適切な措置を講じます。'] },
        { h: '保有期間', body: [
            'お問い合わせおよび資料のご提供に関する個人情報は、対応の完了後、必要な期間を経過した時点で速やかに削除します。',
            'メールマガジンの配信に用いる情報は、配信停止のお手続きをいただいた時点、または当社が配信を終了した時点で削除します。'] },
  ...
  ko: {
    ...
    privacy: {
      ...
      revised: '제정일: 2026년 8월 17일　개정일: 2026년 8월 27일',
      metaTitle: '개인정보 처리방침｜TAG EIGHT',
      metaDesc: 'TAG EIGHT合同会社의 개인정보 취급에 관하여.',
      sections: [
        { h: '수집하는 정보', body: ['당사는 문의 폼 및 자료 다운로드 폼을 통해 다음 정보를 수집합니다.'],
          list: ['회사명·단체명', '성함', '이메일 주소', '문의 유형·메시지 본문', '동의 기록(동의 일시 및 동의한 항목)'] },
        { h: '이용 목적', body: ['수집한 개인정보는 다음 목적의 범위 내에서 이용합니다.'],
          list: ['문의에 대한 답변 및 연락', '서비스 제안 및 미팅 조율', '계약 체결 및 이행', '자료 제공 및 그에 관한 연락', '메일 매거진 발송(별도로 동의하신 경우에 한합니다)'] },
        { h: '메일 매거진 발송', body: [
            '메일 매거진은 발송에 개별적으로 동의하신 분에게만 보내드립니다. 자료 다운로드 시 발송 동의를 필수로 요구하지 않습니다.',
            '발송하는 메일에는 발신자명, 당사 주소, 수신 거부 방법을 기재합니다. 수신 거부는 메일 내 링크를 통해 언제든지 하실 수 있습니다.',
            '문의 폼만 이용하신 분께 메일 매거진을 발송하는 일은 없습니다.'] },
        { h: '제3자 제공', body: ['당사는 법령에 근거한 경우를 제외하고, 본인의 동의 없이 개인정보를 제3자에게 제공하지 않습니다.'] },
        { h: '국외 이전', body: [
            '각 폼으로 전송된 정보는 메일 송수신 및 발송을 위해 국외에 소재한 사업자의 서버를 경유합니다.',
            '당사는 전송 및 발송 목적의 범위 내에서만 해당 사업자를 이용하며, 그 외의 목적으로 정보를 제공하지 않습니다.',
            '각 사업자의 개인정보 처리방침은 각사 공식 사이트에서 확인하실 수 있습니다.'],
          list: ['메일 송수신: Google Workspace (미국)', '호스팅: Cloudflare (미국)', '메일 매거진 발송: 메일 발송 서비스 사업자 (EU 역내)'] },
        { h: '안전 관리', body: ['당사는 개인정보의 유출, 멸실 또는 훼손 방지 및 기타 안전 관리를 위해 필요하고 적절한 조치를 강구합니다.'] },
        { h: '보유 기간', body: [
            '문의 및 자료 제공에 관한 개인정보는 대응 완료 후 필요한 기간이 경과한 시점에 신속히 삭제합니다.',
            '메일 매거진 발송에 이용하는 정보는 수신 거부 절차를 진행하신 시점, 또는 당사가 발송을 종료한 시점에 삭제합니다.'] },
  ...
  'zh-tw': {
    ...
    privacy: {
      ...
      revised: '制定日：2026年8月17日　修訂日：2026年8月27日',
      metaTitle: '隱私權政策｜TAG EIGHT',
      metaDesc: '關於 TAG EIGHT合同会社 的個人資料處理。',
      sections: [
        { h: '蒐集的資訊', body: ['本公司透過聯絡表單及資料下載表單蒐集以下資訊。'],
          list: ['公司／團體名稱', '姓名', '電子郵件地址', '諮詢類型與訊息內容', '同意紀錄（同意時間及所同意之項目）'] },
        { h: '利用目的', body: ['所蒐集的個人資料，僅在下列目的範圍內使用。'],
          list: ['回覆與聯繫諮詢內容', '服務提案與會議安排', '契約之締結與履行', '提供資料及相關聯繫', '電子報之發送（僅限另行表示同意者）'] },
        { h: '電子報之發送', body: [
            '電子報僅發送予個別同意接收的使用者。下載資料時，不會將同意接收電子報列為必要條件。',
            '所發送的郵件將載明寄件者名稱、本公司地址及取消訂閱方式。您可隨時透過郵件內的連結取消訂閱。',
            '僅使用聯絡表單的使用者，本公司不會向其發送電子報。'] },
        { h: '第三方提供', body: ['除法令另有規定外，本公司不會在未經本人同意的情況下，將個人資料提供予第三方。'] },
        { h: '跨境傳輸', body: [
            '透過各表單傳送的資訊，為進行郵件收發及發送，會經由位於境外的服務供應商伺服器。',
            '本公司僅在傳送及發送目的的範圍內使用該等服務，不會為其他目的提供資訊。',
            '各服務供應商的隱私權政策，請於其官方網站確認。'],
          list: ['郵件收發：Google Workspace（美國）', '網站託管：Cloudflare（美國）', '電子報發送：郵件發送服務供應商（歐盟境內）'] },
        { h: '安全管理', body: ['本公司為防止個人資料外洩、滅失或毀損，並確保其他安全管理事項，採取必要且適當的措施。'] },
        { h: '保存期間', body: [
            '與諮詢及資料提供相關的個人資料，於處理完成並經過必要期間後，將迅速刪除。',
            '用於發送電子報的資料，將於您完成取消訂閱手續時，或本公司終止發送時刪除。'] },
