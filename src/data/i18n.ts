  ...
  ja: {
    ...
    contact: {
      ...
      f: {
        ...
        submit: '送信する',
        required: '必須',
        note: 'ご記入いただいた内容は、お問い合わせへの対応にのみ使用します。',
    ...
    privacy: {
      ...
      sections: [
        ...
        { h: '外国にある第三者への提供', body: [
            'お問い合わせフォームから送信された情報は、メールの送受信のため、フランスおよび米国に所在する事業者のサーバーを経由します。',
            '当社は、送信の目的の範囲内でのみ当該事業者を利用し、それ以外の目的で情報を提供することはありません。',
            '各事業者のプライバシーポリシーは、それぞれの公式サイトでご確認いただけます。'],
          list: ['メール配信：Brevo（フランス）', 'ホスティング：Cloudflare（米国）'] },
  ...
  'zh-tw': {
    ...
    privacy: {
      ...
      sections: [
        ...
        { h: '跨境傳輸', body: [
            '透過聯絡表單傳送的資訊，為進行郵件收發，會經由位於法國及美國的服務供應商伺服器。',
            '本公司僅在傳送目的的範圍內使用該等服務，不會為其他目的提供資訊。',
            '各服務供應商的隱私權政策，請於其官方網站確認。'],
          list: ['郵件發送：Brevo（法國）', '網站託管：Cloudflare（美國）'] },
