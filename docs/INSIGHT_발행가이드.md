...
```
![설명](/img/insight/naver-share.png)

_출처: 인터넷트렌드 2026년 4월_
```

- 파일은 `public/img/insight/` 에 둔다
- 이미지 **바로 다음 줄**에 기울임을 쓰면 캡션이 된다
- ⚠️ 그래프는 **이미지로 만들어 올린다.** 표로 될 것은 표로 하는 편이 검색·AI 인용에 유리하다
